...
func Handlers(app *fiber.App, i *shared.Interfaces) {
	...
	app.Get(routes.CharacterApplicationNamePath(routes.ID), handlers.CharacterNamePage(i))
	app.Get(routes.CharacterApplicationGenderPath(routes.ID), handlers.CharacterGenderPage(i))
	app.Get(routes.CharacterApplicationShortDescriptionPath(routes.ID), handlers.CharacterSdescPage(i))
	...
	app.Patch(routes.CharacterApplicationShortDescriptionPath(routes.ID), handlers.UpdateCharacterApplicationSdesc(i))
