...
func main() {
	...
	app.Post(handlers.NewCharacterRoute, handlers.NewCharacterApplication(&i))
	app.Put(handlers.CharacterRoute, handlers.UpdateCharacterApplication(&i))
	app.Get(handlers.NewCharacterNameRoute, handlers.CharacterNamePage(&i))
	app.Get(handlers.NewCharacterGenderRoute, handlers.CharacterGenderPage(&i))
	app.Get(handlers.NewCharacterSdescRoute, handlers.CharacterSdescPage(&i))
	app.Get(handlers.NewCharacterDescriptionRoute, handlers.CharacterDescriptionPage(&i))
	app.Get(handlers.NewCharacterBackstoryRoute, handlers.CharacterBackstoryPage(&i))
